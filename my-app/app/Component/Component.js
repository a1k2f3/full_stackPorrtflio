...
const Header = () => {
  ...
  return (
    <header className={`flex justify-between items-center p-5 bg-black ${Poppins.className} text-white`}>
      ...
      <nav className={`lg:flex space-x-5 flex items-center justify-center  top-0 left-0 sticky ${menuOpen ? 'block flex-col' : 'hidden'} lg:block`}>
        <Link href="#" className="hover:text-gray-400 hover:scale-105 transform transition-transform duration-300 font-semibold tracking-wide">Home</Link>
